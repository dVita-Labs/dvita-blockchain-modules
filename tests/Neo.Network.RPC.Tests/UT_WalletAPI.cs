...
namespace Neo.Network.RPC.Tests
{
    ...
    public class UT_WalletAPI
    {
        ...
        {
            byte[] testScript = NativeContract.DVITA.Hash.MakeScript("unclaimedGas", sender, 99);
        ...
        {
            byte[] testScript = NativeContract.DVITA.Hash.MakeScript("balanceOf", sender);
        ...
        {
            byte[] balanceScript = NativeContract.DVITA.Hash.MakeScript("balanceOf", sender);
            ...
            byte[] testScript = NativeContract.DVITA.Hash.MakeScript("transfer", sender, sender, new BigInteger(1_00000000), null);
            UT_TransactionManager.MockInvokeScript(rpcClientMock, testScript, new ContractParameter { Type = ContractParameterType.Integer, Value = new BigInteger(1_10000000) });
